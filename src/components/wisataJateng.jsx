...
const WisataJateng = () => {
  ...
  useEffect(() => {
    const getData = async () => {
      try {
        const data = await fetchData('http://210.79.191.157:5000/api/wisataJateng');
  ...
  return (
    <div className="container mx-auto px-4 py-16">
      ...
      <div className="mt-8">
        <h2 className="text-xl font-semibold mb-2 text-center md:text-left">Tempat Wisata Menarik di Jawa Tengah</h2>
